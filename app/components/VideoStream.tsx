...
export default function VideoStream({
    ...
    }, [isRecording, captureFrame, sendFrameToBackend, fetchCurrentPosture, analyzeImage, badPostureStart, startIncidentRecording, stopIncidentRecording, frameCount])
    ...
    return (
        <div className="relative">
            <div className="video-container">
                {/* Raw webcam feed (hidden, used for frame capture) */}
                <video
                    ref={videoRef}
                    autoPlay
                    muted
                ...
                {/* Processed video stream with MediaPipe overlay */}
                {showProcessedVideo && (
                    <img
                        ref={processedVideoRef}
                        src="http://localhost:5001/api/video-stream"
